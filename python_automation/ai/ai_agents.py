...
class AiAgents():
  ...
  def job_application_writer(self):
    return Agent(
      ...
      """,
      tools=[
        # CSVTools.generate_experience_number,
        # UserDataTools.fetch_user_data
      ],
      verbose=True,
      allow_delegation=False,
      llm=llama2
